...
public final class Archimate {
    private static final Set<String> RELATIONSHIP_CONNECTOR_TYPES = Set.of("AndJunction", "OrJunction");
    ...
    private static final List<RelationshipEndpointTriple> CURATED_RELATIONSHIP_ENDPOINT_TRIPLES = List.of(
            ...
            new RelationshipEndpointTriple("ApplicationComponent", "Realization", "ApplicationService"),
            new RelationshipEndpointTriple("ApplicationComponent", "Specialization", "ApplicationComponent"),
            ...
            new RelationshipEndpointTriple("ApplicationService", "Triggering", "ApplicationComponent"),
            new RelationshipEndpointTriple("BusinessActor", "Association", "DataObject"));

    private static final Set<RelationshipEndpointTriple> REJECTED_RELATIONSHIP_ENDPOINT_TRIPLES = Set.of(
            new RelationshipEndpointTriple("ApplicationService", "Realization", "ApplicationComponent"),
    ...
    public static void validateElementType(String value, String path) throws ArchimateTypeValidationException {
        if (!ELEMENT_TYPES.contains(value)) {
            throw new ArchimateTypeValidationException(ArchimateTypeKind.ELEMENT, value, path);
        }
    }

    public static void validateRelationshipType(String value, String path) throws ArchimateTypeValidationException {
    ...
    public static void validateRelationshipEndpointTypes(
            ...
            String sourceType,
            String targetType,
            String path) throws ArchimateTypeValidationException {
    ...
    public static void validateJunctionRelationshipSemantics(
            List<JunctionValidationNode> nodes,
            List<JunctionValidationRelationship> relationships) throws ArchimateJunctionValidationException {
        ...
        for (JunctionValidationNode node : nodes) {
            ...
            var incidentRelationships = relationships.stream()
                    .filter(relationship -> relationship.source().equals(node.id())
    ...
    private static void validateJunctionReachableTargets(
            ...
            Set<String> visited) throws ArchimateJunctionValidationException {
    ...
    private static boolean isJunctionContainmentRelationship(
            JunctionValidationRelationship relationship,
            Map<String, String> nodeTypes) {
