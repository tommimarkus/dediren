...
| `svg-render` | `dediren-plugin-svg-render` | SVG (and optional interactive HTML) rendering. See [SVG Rendering](svg-render.md). |
...
override `DEDIREN_PLUGIN_<PLUGIN_ID>` (e.g. `DEDIREN_PLUGIN_SVG_RENDER`) points a
