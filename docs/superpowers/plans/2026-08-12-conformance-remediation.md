...
| ~~F3~~ | **CLOSED.** The §B.4 domain dimension for ArchiMate legality. | The model now carries domain alongside category. §B.4's four domains and their crossing restrictions are enforced; containment is split into its three actual rules (§B.6 for grouping/location/plateau, §8.5.1's closed list for product, §5.1.1 for everything else). Measured against the Appendix-B oracle at each step: **79.9% → 88.2% caught, zero false negatives throughout**. `CATCH_RATE_FLOOR` rises to 0.88. | Closed 2026-08-12 once the specification was available locally — which was the whole blocker. Two intermediate states were caught by the oracle and corrected before landing: enforcing crossings without §B.6 rejected 40 plateau containments, and product's closed list initially dropped §5.1.1's same-type rule. Neither would have been visible without it. Residue recorded in §12: containment is still decided on category rather than element type. |
