...
```text
dist/dediren-agent-bundle-2026.07.17/
dist/dediren-agent-bundle-2026.07.17.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.17/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.17' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.17 -m "Release 2026.07.17"
```
