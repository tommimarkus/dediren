...
```text
dist/dediren-agent-bundle-2026.07.7/
dist/dediren-agent-bundle-2026.07.7.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.7/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.7' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.7 -m "Release 2026.07.7"
```
