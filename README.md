...
```text
dist/dediren-agent-bundle-2026.07.4/
dist/dediren-agent-bundle-2026.07.4.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.4/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.4' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.4 -m "Release 2026.07.4"
```
