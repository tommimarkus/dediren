...
`render_policy` is supplied; source SVG requires an explicit policy. The same
output selector is available to `dediren_build`; see the agent guide for
limits, client display support, and failure handling.
