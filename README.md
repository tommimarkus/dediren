...
```text
dist/dediren-agent-bundle-2026.07.20/
dist/dediren-agent-bundle-2026.07.20.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.20/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.20' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.20 -m "Release 2026.07.20"
```
