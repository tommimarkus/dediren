...
```text
dist/dediren-agent-bundle-2026.07.18/
dist/dediren-agent-bundle-2026.07.18.tar.gz
```
...
```bash
./mvnw versions:set -DnewVersion='2026.07.18' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.18 -m "Release 2026.07.18"
```
