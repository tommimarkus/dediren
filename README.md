...
```text
dist/dediren-agent-bundle-2026.07.29/
dist/dediren-agent-bundle-2026.07.29.tar.xz
```
...
```text
dediren-agent-bundle-2026.07.29/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.29' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.29 -m "Release 2026.07.29"
```
