...
```text
dist/dediren-agent-bundle-2026.07.19/
dist/dediren-agent-bundle-2026.07.19.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.19/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.19' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.19 -m "Release 2026.07.19"
```
