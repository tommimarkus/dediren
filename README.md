...
For the current `0.8.1` version, the xtask creates:

```text
dist/dediren-agent-bundle-0.8.1-x86_64-unknown-linux-gnu/
dist/dediren-agent-bundle-0.8.1-x86_64-unknown-linux-gnu.tar.gz
```
...
```bash
cargo xtask dist smoke dist/dediren-agent-bundle-0.8.1-x86_64-unknown-linux-gnu.tar.gz
```
...
tar -xzf dist/dediren-agent-bundle-0.8.1-x86_64-unknown-linux-gnu.tar.gz -C /tmp/dediren-dist
/tmp/dediren-dist/dediren-agent-bundle-0.8.1-x86_64-unknown-linux-gnu/bin/dediren --help
```
