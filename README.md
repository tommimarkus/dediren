...
```text
dediren-agent-bundle-2026.07.21/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.21' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.21 -m "Release 2026.07.21"
```
