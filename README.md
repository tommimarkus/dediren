...
```text
dist/dediren-agent-bundle-2026.07.25/
dist/dediren-agent-bundle-2026.07.25.tar.xz
```
...
```text
dediren-agent-bundle-2026.07.25/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.25' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.25 -m "Release 2026.07.25"
```
