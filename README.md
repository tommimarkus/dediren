...
```text
dist/dediren-agent-bundle-2026.07.5/
dist/dediren-agent-bundle-2026.07.5.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.5/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.5' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.5 -m "Release 2026.07.5"
```
