...
```text
dist/dediren-agent-bundle-2026.07.10/
dist/dediren-agent-bundle-2026.07.10.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.10/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.10' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.10 -m "Release 2026.07.10"
```
