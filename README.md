...
```text
dist/dediren-agent-bundle-2026.08.6/
dist/dediren-agent-bundle-2026.08.6.tar.xz
```
...
```text
dediren-agent-bundle-2026.08.6/
...
```bash
./mvnw versions:set -DnewVersion='2026.08.6' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.08.6 -m "Release 2026.08.6"
```
