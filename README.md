...
```text
dist/dediren-agent-bundle-2026.07.24/
dist/dediren-agent-bundle-2026.07.24.tar.xz
```
...
```text
dediren-agent-bundle-2026.07.24/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.24' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.24 -m "Release 2026.07.24"
```
