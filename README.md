...
```text
dist/dediren-agent-bundle-2026.07.14/
dist/dediren-agent-bundle-2026.07.14.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.14/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.14' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.14 -m "Release 2026.07.14"
```
