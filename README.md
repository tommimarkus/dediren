...
```text
dist/dediren-agent-bundle-2026.07.28/
dist/dediren-agent-bundle-2026.07.28.tar.xz
```
...
```text
dediren-agent-bundle-2026.07.28/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.28' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.28 -m "Release 2026.07.28"
```
