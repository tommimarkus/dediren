...
```text
dist/dediren-agent-bundle-2026.07.11/
dist/dediren-agent-bundle-2026.07.11.tar.gz
```
...
```text
dediren-agent-bundle-2026.07.11/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.11' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.11 -m "Release 2026.07.11"
```
