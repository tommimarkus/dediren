...
```text
dist/dediren-agent-bundle-2026.07.23/
dist/dediren-agent-bundle-2026.07.23.tar.xz
```
...
```text
dediren-agent-bundle-2026.07.23/
...
```bash
./mvnw versions:set -DnewVersion='2026.07.23' -DprocessAllModules=true -DgenerateBackupPoms=false
```
...
```bash
git tag -a v2026.07.23 -m "Release 2026.07.23"
```
