...
public final class Main {
    ...
    private static String nodeLabel(LaidOutNode node, ResolvedNodeStyle style, double fontSize) {
        ...
        StringBuilder svg = new StringBuilder(String.format(
                Locale.ROOT,
    ...
    private static List<String> splitCamelToken(String token) {
        ...
        for (int index = 0; index < codePoints.length; index++) {
            ...
            boolean nextIsLowercase = index + 1 < codePoints.length && Character.isLowerCase(codePoints[index + 1]);
    ...
    private static String archimateIconBody(
        ...
        return switch (kind) {
            ...
            case INTERFACE -> String.format(
                    ...
                    stroke,
                    width);
            case COLLABORATION -> String.format(
                    Locale.ROOT,
                    ...
                    stroke,
                    width);
            case ROLE, STAKEHOLDER -> String.format(
                    Locale.ROOT,
            ...
            case INTERACTION -> String.format(
                    Locale.ROOT,
            ...
            case PROCESS -> String.format(
                    ...
                    stroke,
                    width);
            case COURSE_OF_ACTION -> archimateTargetIconBody(x, y, size, fill, stroke, width, TargetIconStyle.HANDLE);
            ...
            case PRODUCT -> String.format(
                    ...
                    stroke,
                    width);
            case REPRESENTATION -> String.format(
                    Locale.ROOT,
            ...
            case ASSESSMENT -> String.format(
                    ...
                    stroke,
                    width);
            case GOAL -> archimateTargetIconBody(x, y, size, fill, stroke, width, TargetIconStyle.BULLSEYE);
            case OUTCOME -> archimateTargetIconBody(x, y, size, fill, stroke, width, TargetIconStyle.ARROW);
            ...
            case CONSTRAINT -> String.format(
                    ...
                    stroke,
                    width);
            case REQUIREMENT -> String.format(
                    Locale.ROOT,
            ...
            case RESOURCE -> String.format(
                    ...
                    stroke,
                    width);
            case VALUE_STREAM -> String.format(
                    Locale.ROOT,
            ...
            case DELIVERABLE -> archimateWavyDocumentIconBody("wavy-document", x, y, size, fill, stroke, width);
            case GAP -> String.format(
                    Locale.ROOT,
                    ...
                    stroke,
                    width);
            case ARTIFACT -> archimateFoldedDocumentIconBody("artifact-document", x, y - 1.0, size, fill, stroke, width);
            case SYSTEM_SOFTWARE -> String.format(
                    Locale.ROOT,
            ...
            case DISTRIBUTION_NETWORK -> archimateDistributionNetworkIconBody(x, y, size, fill, stroke, width);
    ...
    private static String archimateServiceIconBody(
            ...
            String stroke,
            String width) {
        double serviceY = decorator == SvgNodeDecorator.ARCHIMATE_APPLICATION_SERVICE ? y : y + size * 0.12;
        double serviceHeight = decorator == SvgNodeDecorator.ARCHIMATE_APPLICATION_SERVICE ? size * 0.62 : size * 0.5;
        return String.format(
                Locale.ROOT,
    ...
    private static String archimateTargetIconBody(
        ...
        return switch (style) {
            case BULLSEYE -> rings;
            case ARROW -> rings + String.format(
                    Locale.ROOT,
                    ...
                    stroke,
                    width);
            case HANDLE -> rings + String.format(
                    Locale.ROOT,
    ...
    private static String archimateEquipmentIconBody(
            ...
            String stroke,
            String width) {
        return archimateGearPath("equipment-gear-large", x + size * 0.34, y + size * 0.52,
                size * 0.24, fill, stroke, width)
                + String.format(
                        Locale.ROOT,
                        ...
                        stroke,
                        width)
                + archimateGearPath("equipment-gear-small", x + size * 0.68, y + size * 0.24,
                        size * 0.16, fill, stroke, width)
                + String.format(
                        Locale.ROOT,
                        "<circle data-dediren-icon-part=\"equipment-gear-hole\" cx=\"%.1f\" cy=\"%.1f\" r=\"%.1f\" fill=\"none\" stroke=\"%s\" stroke-width=\"%s\"/>",
                        x + size * 0.68,
    ...
    private static String archimateGearPath(
        ...
        return "<path data-dediren-icon-part=\"" + attr(part) + "\" d=\"" + d
    ...
    private static ArchimateIconKind archimateIconKind(SvgNodeDecorator decorator) {
        return switch (decorator) {
            case ARCHIMATE_BUSINESS_INTERFACE,
                    ...
                    ARCHIMATE_TECHNOLOGY_INTERFACE -> ArchimateIconKind.INTERFACE;
            case ARCHIMATE_BUSINESS_COLLABORATION,
                    ARCHIMATE_APPLICATION_COLLABORATION,
                    ARCHIMATE_TECHNOLOGY_COLLABORATION -> ArchimateIconKind.COLLABORATION;
            ...
            case ARCHIMATE_BUSINESS_SERVICE,
                    ...
                    ARCHIMATE_TECHNOLOGY_SERVICE -> ArchimateIconKind.SERVICE;
            case ARCHIMATE_BUSINESS_INTERACTION,
                    ARCHIMATE_APPLICATION_INTERACTION,
                    ARCHIMATE_TECHNOLOGY_INTERACTION -> ArchimateIconKind.INTERACTION;
            case ARCHIMATE_BUSINESS_FUNCTION,
                    ARCHIMATE_APPLICATION_FUNCTION,
                    ARCHIMATE_TECHNOLOGY_FUNCTION -> ArchimateIconKind.FUNCTION;
            case ARCHIMATE_BUSINESS_PROCESS,
                    ARCHIMATE_APPLICATION_PROCESS,
                    ARCHIMATE_TECHNOLOGY_PROCESS -> ArchimateIconKind.PROCESS;
            case ARCHIMATE_BUSINESS_EVENT,
                    ARCHIMATE_APPLICATION_EVENT,
                    ARCHIMATE_TECHNOLOGY_EVENT,
                    ARCHIMATE_IMPLEMENTATION_EVENT -> ArchimateIconKind.EVENT;
    ...
    private static List<EdgeLabel> verticalLabelCandidates(
            ...
            double fontSize) {
        List<EdgeLabel> candidates = new ArrayList<>();
        List<SvgEdgeLabelVerticalSide> sides = style.labelVerticalSide() == SvgEdgeLabelVerticalSide.RIGHT
