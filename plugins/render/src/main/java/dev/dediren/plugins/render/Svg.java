 ...
 * decorators. No state and no rendering policy: just XML escaping, coordinate/number formatting, and
 * a cheap text-width estimate. Consumers static-import these so call sites stay unqualified.
 */
final class Svg {
    private Svg() {
    }
    ...
    static String styleNumber(double value) {
    ...
    static String labelNumber(double value) {
    ...
    static double estimateTextWidth(String value, double fontSize) {
