...
/**
 * Generic JSON property-reader helpers shared by the UML validation surface.
 * Behavior is intentionally identical to the inlined helpers that previously
 * lived in {@link Uml}; these only operate on Jackson nodes and node-type maps.
 */
final class UmlProperties {
    ...
    static JsonNode optionalArrayProperty(
            JsonNode umlProperties,
            String field,
            String umlPath) throws UmlValidationException {
