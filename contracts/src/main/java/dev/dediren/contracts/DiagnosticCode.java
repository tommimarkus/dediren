...
public enum DiagnosticCode {
  ...
  // ASCII text render engine.
  ASCII_EDGE_APPROXIMATED("DEDIREN_ASCII_EDGE_APPROXIMATED"),
  ASCII_EDGE_LABEL_DROPPED("DEDIREN_ASCII_EDGE_LABEL_DROPPED"),
  ASCII_LABEL_TRUNCATED("DEDIREN_ASCII_LABEL_TRUNCATED"),
  ASCII_POLICY_INVALID("DEDIREN_ASCII_POLICY_INVALID"),
  ASCII_SEQUENCE_VIEW_GENERIC("DEDIREN_ASCII_SEQUENCE_VIEW_GENERIC"),

  // Mermaid flowchart import. Parse/compatibility errors are input errors (exit 2); discarded
  // presentation hints are aggregated into one warning on successful import.
  MERMAID_SYNTAX_INVALID("DEDIREN_MERMAID_SYNTAX_INVALID"),
  MERMAID_UNSUPPORTED_DIAGRAM("DEDIREN_MERMAID_UNSUPPORTED_DIAGRAM"),
  MERMAID_UNSUPPORTED_CONSTRUCT("DEDIREN_MERMAID_UNSUPPORTED_CONSTRUCT"),
  MERMAID_UNSUPPORTED_EDGE("DEDIREN_MERMAID_UNSUPPORTED_EDGE"),
  MERMAID_INPUT_TOO_LARGE("DEDIREN_MERMAID_INPUT_TOO_LARGE"),
  MERMAID_STATEMENT_LIMIT_EXCEEDED("DEDIREN_MERMAID_STATEMENT_LIMIT_EXCEEDED"),
  MERMAID_ELEMENT_LIMIT_EXCEEDED("DEDIREN_MERMAID_ELEMENT_LIMIT_EXCEEDED"),
  MERMAID_NESTING_LIMIT_EXCEEDED("DEDIREN_MERMAID_NESTING_LIMIT_EXCEEDED"),
  MERMAID_TOKEN_LIMIT_EXCEEDED("DEDIREN_MERMAID_TOKEN_LIMIT_EXCEEDED"),
  MERMAID_HINT_IGNORED("DEDIREN_MERMAID_HINT_IGNORED"),

  // DOT graph import. Parse/compatibility errors are input errors (exit 2); discarded
  // presentation hints are aggregated into one warning on successful import.
  DOT_SYNTAX_INVALID("DEDIREN_DOT_SYNTAX_INVALID"),
  DOT_UNSUPPORTED_CONSTRUCT("DEDIREN_DOT_UNSUPPORTED_CONSTRUCT"),
  DOT_INPUT_TOO_LARGE("DEDIREN_DOT_INPUT_TOO_LARGE"),
  DOT_STATEMENT_LIMIT_EXCEEDED("DEDIREN_DOT_STATEMENT_LIMIT_EXCEEDED"),
  DOT_ELEMENT_LIMIT_EXCEEDED("DEDIREN_DOT_ELEMENT_LIMIT_EXCEEDED"),
  DOT_NESTING_LIMIT_EXCEEDED("DEDIREN_DOT_NESTING_LIMIT_EXCEEDED"),
  DOT_TOKEN_LIMIT_EXCEEDED("DEDIREN_DOT_TOKEN_LIMIT_EXCEEDED"),
  DOT_HINT_IGNORED("DEDIREN_DOT_HINT_IGNORED"),

  // draw.io import/export. Import parse/compatibility errors and anti-exhaustion ceilings are
  // input errors (exit 2); discarded presentation hints and lossy simplifications are aggregated
  // into warnings/info on successful import. The export codes mirror the shared OEF/UML-XMI export
  // shape: a policy tripwire, an unmapped node kind, a missing layout reference, and an omitted
  // ornament the format cannot express.
  DRAWIO_CELL_LIMIT_EXCEEDED("DEDIREN_DRAWIO_CELL_LIMIT_EXCEEDED"),
  DRAWIO_CELLS_SKIPPED("DEDIREN_DRAWIO_CELLS_SKIPPED"),
  DRAWIO_DECOMPRESSED_TOO_LARGE("DEDIREN_DRAWIO_DECOMPRESSED_TOO_LARGE"),
  DRAWIO_DECOMPRESSION_FAILED("DEDIREN_DRAWIO_DECOMPRESSION_FAILED"),
  DRAWIO_ELEMENT_LIMIT_EXCEEDED("DEDIREN_DRAWIO_ELEMENT_LIMIT_EXCEEDED"),
  DRAWIO_HINT_IGNORED("DEDIREN_DRAWIO_HINT_IGNORED"),
  DRAWIO_INPUT_TOO_LARGE("DEDIREN_DRAWIO_INPUT_TOO_LARGE"),
  DRAWIO_KIND_INFERRED("DEDIREN_DRAWIO_KIND_INFERRED"),
  DRAWIO_LAYERS_FLATTENED("DEDIREN_DRAWIO_LAYERS_FLATTENED"),
  DRAWIO_LAYOUT_REFERENCE_MISSING("DEDIREN_DRAWIO_LAYOUT_REFERENCE_MISSING"),
  DRAWIO_NESTING_LIMIT_EXCEEDED("DEDIREN_DRAWIO_NESTING_LIMIT_EXCEEDED"),
  DRAWIO_ORNAMENT_OMITTED("DEDIREN_DRAWIO_ORNAMENT_OMITTED"),
  DRAWIO_PAGE_LIMIT_EXCEEDED("DEDIREN_DRAWIO_PAGE_LIMIT_EXCEEDED"),
  DRAWIO_POLICY_INVALID("DEDIREN_DRAWIO_POLICY_INVALID"),
  DRAWIO_PROPERTIES_DROPPED("DEDIREN_DRAWIO_PROPERTIES_DROPPED"),
  DRAWIO_ROUND_TRIP_INVALID("DEDIREN_DRAWIO_ROUND_TRIP_INVALID"),
  DRAWIO_SHAPE_UNMAPPED("DEDIREN_DRAWIO_SHAPE_UNMAPPED"),
  DRAWIO_SYNTAX_INVALID("DEDIREN_DRAWIO_SYNTAX_INVALID"),
  DRAWIO_TOKEN_LIMIT_EXCEEDED("DEDIREN_DRAWIO_TOKEN_LIMIT_EXCEEDED"),
  DRAWIO_UNSUPPORTED_CONSTRUCT("DEDIREN_DRAWIO_UNSUPPORTED_CONSTRUCT"),
  DRAWIO_UNSUPPORTED_DOCUMENT("DEDIREN_DRAWIO_UNSUPPORTED_DOCUMENT"),
  ...
  ARCHIMATE_RELATIONSHIP_DEPRECATED("DEDIREN_ARCHIMATE_RELATIONSHIP_DEPRECATED"),
  UML_SEQUENCE_HOUSE_RULE("DEDIREN_UML_SEQUENCE_HOUSE_RULE"),
  OEF_GEOMETRY_CLAMPED("DEDIREN_OEF_GEOMETRY_CLAMPED"),
  OEF_LAYOUT_REFERENCE_MISSING("DEDIREN_OEF_LAYOUT_REFERENCE_MISSING"),
  OEF_POLICY_INVALID("DEDIREN_OEF_POLICY_INVALID"),
  OEF_PROPERTY_FLATTENED("DEDIREN_OEF_PROPERTY_FLATTENED"),
  OEF_SCHEMA_INVALID("DEDIREN_OEF_SCHEMA_INVALID"),
  OEF_SCHEMA_UNAVAILABLE("DEDIREN_OEF_SCHEMA_UNAVAILABLE"),
  OEF_VIEWPOINT_UNKNOWN("DEDIREN_OEF_VIEWPOINT_UNKNOWN"),
  ...
  ELK_GROUP_BANDS_OVERLAP("DEDIREN_ELK_GROUP_BANDS_OVERLAP"),
  ...
  // SVG render engine.
  RENDER_EDGE_LABEL_CONSTRAINED("DEDIREN_RENDER_EDGE_LABEL_CONSTRAINED"),
  RENDER_EDGE_LABEL_OCCLUDED("DEDIREN_RENDER_EDGE_LABEL_OCCLUDED"),
  RENDER_METADATA_PROFILE_MISMATCH("DEDIREN_RENDER_METADATA_PROFILE_MISMATCH"),
  RENDER_METADATA_PROFILE_NOT_APPLIED("DEDIREN_RENDER_METADATA_PROFILE_NOT_APPLIED"),
  ...
  // Package build (core PackageBuildCommand): a package document's cross-references and declared
  // output topology, validated before any engine runs.
  PACKAGE_MODEL_UNKNOWN("DEDIREN_PACKAGE_MODEL_UNKNOWN"),
