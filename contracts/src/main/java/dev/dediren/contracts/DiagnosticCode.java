 ...
 * diagnostic codes only, not {@code DEDIREN_*} environment-variable names (for example
 * {@code DEDIREN_PLUGIN_DIRS}), which are a separate vocabulary. The {@link #code()} string is the
 * wire contract and must never change for an existing constant.
 */
