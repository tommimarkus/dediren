...
class DiagnosticCodeTest {
    ...
    void pluginRuntimeFamilyExposesItsCanonicalWireStrings() {
        assertThat(DiagnosticCode.PLUGIN_MISSING_EXECUTABLE.code()).isEqualTo("DEDIREN_PLUGIN_MISSING_EXECUTABLE");
        ...
        assertThat(DiagnosticCode.PLUGIN_OUTPUT_INVALID_JSON.code()).isEqualTo("DEDIREN_PLUGIN_OUTPUT_INVALID_JSON");
        assertThat(DiagnosticCode.PLUGIN_OUTPUT_INVALID_ENVELOPE.code())
                .isEqualTo("DEDIREN_PLUGIN_OUTPUT_INVALID_ENVELOPE");
        assertThat(DiagnosticCode.PLUGIN_OUTPUT_INVALID_DATA.code()).isEqualTo("DEDIREN_PLUGIN_OUTPUT_INVALID_DATA");
    }

    @Test
    void commandSourceAndLayoutFamiliesExposeTheirCanonicalWireStrings() {
        assertThat(DiagnosticCode.COMMAND_INPUT_INVALID.code()).isEqualTo("DEDIREN_COMMAND_INPUT_INVALID");
        assertThat(DiagnosticCode.VALIDATE_PROFILE_REQUIRED.code()).isEqualTo("DEDIREN_VALIDATE_PROFILE_REQUIRED");
        assertThat(DiagnosticCode.VALIDATE_PLUGIN_REQUIRED.code()).isEqualTo("DEDIREN_VALIDATE_PLUGIN_REQUIRED");
        ...
        assertThat(DiagnosticCode.LAYOUT_ROUTE_POINTS_EMPTY.code()).isEqualTo("DEDIREN_LAYOUT_ROUTE_POINTS_EMPTY");
