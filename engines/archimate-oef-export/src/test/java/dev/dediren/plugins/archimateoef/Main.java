...
/**
 * Envelope-shaped test harness for the ArchiMate/OEF export: it parses stdin, delegates to {@link
 * OefExportEngine}, and shapes the command envelope so the existing envelope-asserting suites can
